...
//     try {
//       await axios.post(`https://waterway-booking2.onrender.com/api/boats/${boatId}/unavailable-dates`, { dates: unavailableDates });
...
//     try {
//       await axios.post(`https://waterway-booking2.onrender.com/api/boats/${boatId}/food-customization`, { customization: foodCustomization });
...
//selected foods
  ...
  useEffect(() => {
    const fetchFoodData = async () => {
      try {
        const response = await axios.get(`https://waterway-booking2.onrender.com/api/food/${boatId}/food`);
  ...
  useEffect(() => {
    const fetchBoatDetails = async () => {
      try {
        const response = await axios.get(`https://waterway-booking2.onrender.com/api/boats/menu/${boatId}`);
  ...
  const handleFoodCustomizationSubmit = async () => {
    try {
      ...
      await axios.post(`https://waterway-booking2.onrender.com/api/food/${boatId}/food`, foodData);
      alert('Food customization updated');
    } catch (error) {
      console.error('Error updating food customization:', error);
    }
