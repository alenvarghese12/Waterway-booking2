...
const BoatRegistration = () => {
  ...
  useEffect(() => {
    const fetchBoatTypes = async () => {
      try {
        const response = await axios.get('https://waterway-booking2-1.onrender.com/api/boats/types');
    ...
    const fetchSessionData = async () => {
      ...
      try {
        const response = await axios.get('https://waterway-booking2-1.onrender.com/api/auth/sessionn', {
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const nameCheckResponse = await axios.post('https://waterway-booking2-1.onrender.com/api/boats/checkName', 
      ...
      const registerResponse = await axios.post('https://waterway-booking2-1.onrender.com/api/boats/register', data, {
        headers: {
