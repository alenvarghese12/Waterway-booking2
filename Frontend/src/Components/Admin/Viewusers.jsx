...
const Viewusers = () => {
  ...
  //     try {
  //       const response = await axios.get('https://waterway-booking2.onrender.com/api/auth/users');
  ...
  //   try {
  //     await axios.delete(`https://waterway-booking2.onrender.com/api/auth/users/${userId}`);
